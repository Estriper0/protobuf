...
type AuthClient interface {
	...
	Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*EmptyRequest, error)
...
func (c *authClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*EmptyRequest, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	Logout(context.Context, *LogoutRequest) (*EmptyRequest, error)
...
func (UnimplementedAuthServer) Logout(context.Context, *LogoutRequest) (*EmptyRequest, error) {
